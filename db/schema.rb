...
ActiveRecord::Schema[7.0].define(version: 2022_03_31_202535) do
  ...
  create_table "elementos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_elementos_on_post_id"
  end

  create_table "posts", force: :cascade do |t|
    t.string "titulo"
    t.text "titulo_descripcion"
    t.boolean "publicado"
    t.datetime "publicado_el"
  ...
  add_foreign_key "elementos", "posts"
